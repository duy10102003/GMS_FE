          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="form-section">
              ...
              <div v-if="showNewCustomer || !form.customerId" class="form-row mt-3">
                <div class="col-md-4">
                  <GmsInput
                    v-model="form.customerInfo.customerName"
                    label="Họ và tên *"
                ...
                <div class="col-md-4">
                  <GmsInput
                    v-model="form.customerInfo.customerPhone"
                    label="Số điện thoại *"
                    type="tel"
                ...
                <div class="col-md-4">
                  <GmsInput
                    v-model="form.customerInfo.customerEmail"
                    label="Email"
                    type="email"
            ...
            <div class="form-section">
              ...
              <div v-if="showNewVehicle || !form.vehicleId" class="form-row mt-3">
                <div class="col-md-3">
                  <GmsInput
                    v-model="form.vehicleInfo.vehicleName"
                    label="Tên xe *"
                ...
                <div class="col-md-2">
                  <GmsInput
                    v-model="form.vehicleInfo.model"
                    label="Model"
                    placeholder="Civic"
                  />
                </div>
                <div class="col-md-2">
                  <GmsInput
                    v-model.number="form.vehicleInfo.currentKm"
                    label="Số km"
                    type="number"
                    placeholder="50000"
                  />
            ...
            <div class="form-section">
              <h5 class="section-title">
                <i class="fas fa-exclamation-circle me-2"></i>Vấn đề ban đầu
              </h5>
            <div class="mb-3">
              <label class="form-label">Mô tả vấn đề *</label>
              <textarea
                v-model="form.initialIssue"
                class="form-control"
                rows="4"
            ...
            <div class="form-section">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <GmsInput
                    v-model="form.assignDescription"
                    label="Mô tả công việc"
                    placeholder="Nhập mô tả công việc cho thợ..."
                    :disabled="!form.assignedToTechnical"
                  />
                </div>
              </div>
            </div>
